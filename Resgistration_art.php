...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<body>
        ...
        <div class="container">
            <form action="classes/registerArtist.php" id="registerForm" method="POST" enctype="multipart/form-data">
                <div class="row">

                    <div class="col-md-6">
                        <h3 class="section-title">Register as an Artist</h3>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <label for="fileInput" class="custom-file-upload">
                                        <i class="fas fa-upload"></i> Upload your Picture
                                    </label>
